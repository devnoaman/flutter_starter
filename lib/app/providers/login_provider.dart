...
final authStateProvider = StateNotifierProvider<AuthNotifier, AuthState>((ref) {
  ...
  var v = _connectionState.maybeWhen(
    noConnection: (msg) => AuthNotifier(false),
    orElse: () => AuthNotifier(true),
  );
  return v;
});
...
class AuthNotifier extends StateNotifier<AuthState> {
  AuthNotifier(bool bool) : super(const AuthState.initial()) {
    ...
    ///this just for demo perposes. must be replaced with the logic
    ///that check the state of app connection
    if (bool) {
